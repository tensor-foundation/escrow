...
export type T22BuyNftInstruction<
...
export type T22BuyNftInstructionWithSigners<
  TProgram extends string = 'TSWAPaqyCSx2KABk68Shruf4rp7CxcNi8hAsbdwmHbN',
  TAccountTswap extends string | IAccountMeta<string> = string,
  TAccountFeeVault extends string | IAccountMeta<string> = string,
  TAccountPool extends string | IAccountMeta<string> = string,
...
export type T22BuyNftInstructionData = {
  discriminator: Array<number>;
  config: PoolConfig;
  maxPrice: bigint;
};

export type T22BuyNftInstructionDataArgs = {
  config: PoolConfigArgs;
  maxPrice: number | bigint;
};

export function getT22BuyNftInstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: Array<number>;
      config: PoolConfigArgs;
  ...
  ) satisfies Encoder<T22BuyNftInstructionDataArgs>;
}

export function getT22BuyNftInstructionDataDecoder() {
  return getStructDecoder<T22BuyNftInstructionData>([
    ['discriminator', getArrayDecoder(getU8Decoder(), { size: 8 })],
    ['config', getPoolConfigDecoder()],
    ['maxPrice', getU64Decoder()],
  ]) satisfies Decoder<T22BuyNftInstructionData>;
}

export function getT22BuyNftInstructionDataCodec(): Codec<
  T22BuyNftInstructionDataArgs,
  T22BuyNftInstructionData
> {
  return combineCodec(
    getT22BuyNftInstructionDataEncoder(),
    getT22BuyNftInstructionDataDecoder()
  );
}

export type T22BuyNftInput<
  TAccountTswap extends string,
  TAccountFeeVault extends string,
  TAccountPool extends string,
  TAccountWhitelist extends string,
...
> = {
  ...
  config: T22BuyNftInstructionDataArgs['config'];
  maxPrice: T22BuyNftInstructionDataArgs['maxPrice'];
};

export type T22BuyNftInputWithSigners<
  TAccountTswap extends string,
  TAccountFeeVault extends string,
  TAccountPool extends string,
  TAccountWhitelist extends string,
...
export function getT22BuyNftInstruction<
  TAccountTswap extends string,
  TAccountFeeVault extends string,
  TAccountPool extends string,
  TAccountWhitelist extends string,
  ...
  TProgram extends string = 'TSWAPaqyCSx2KABk68Shruf4rp7CxcNi8hAsbdwmHbN'
>(
  input: T22BuyNftInputWithSigners<
    TAccountTswap,
    TAccountFeeVault,
    TAccountPool,
    TAccountWhitelist,
    ...
    TAccountTakerBroker
  >
): T22BuyNftInstructionWithSigners<
  TProgram,
  TAccountTswap,
  TAccountFeeVault,
  TAccountPool,
...
>(
  ...
  type AccountMetas = Parameters<
    typeof getT22BuyNftInstructionRaw<
      TProgram,
      TAccountTswap,
      TAccountFeeVault,
      TAccountPool,
  ...
  const instruction = getT22BuyNftInstructionRaw(
    accountMetas as Record<keyof AccountMetas, IAccountMeta>,
    args as T22BuyNftInstructionDataArgs,
    programAddress
  );
...
export function getT22BuyNftInstructionRaw<
  TProgram extends string = 'TSWAPaqyCSx2KABk68Shruf4rp7CxcNi8hAsbdwmHbN',
  TAccountTswap extends string | IAccountMeta<string> = string,
  TAccountFeeVault extends string | IAccountMeta<string> = string,
  TAccountPool extends string | IAccountMeta<string> = string,
...
>(
  ...
  args: T22BuyNftInstructionDataArgs,
  ...
  return {
    ...
    data: getT22BuyNftInstructionDataEncoder().encode(args),
    programAddress,
  } as T22BuyNftInstruction<
    TProgram,
    TAccountTswap,
    TAccountFeeVault,
    TAccountPool,
...
export type ParsedT22BuyNftInstruction<
  TProgram extends string = 'TSWAPaqyCSx2KABk68Shruf4rp7CxcNi8hAsbdwmHbN',
...
> = {
  ...
  data: T22BuyNftInstructionData;
};

export function parseT22BuyNftInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedT22BuyNftInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getT22BuyNftInstructionDataDecoder().decode(instruction.data),
  };
}
