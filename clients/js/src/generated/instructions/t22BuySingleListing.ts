...
export type T22BuySingleListingInstruction<
...
export type T22BuySingleListingInstructionWithSigners<
  TProgram extends string = 'TSWAPaqyCSx2KABk68Shruf4rp7CxcNi8hAsbdwmHbN',
  TAccountTswap extends string | IAccountMeta<string> = string,
  TAccountFeeVault extends string | IAccountMeta<string> = string,
  TAccountSingleListing extends string | IAccountMeta<string> = string,
...
export type T22BuySingleListingInstructionData = {
  discriminator: Array<number>;
  maxPrice: bigint;
};

export type T22BuySingleListingInstructionDataArgs = {
  maxPrice: number | bigint;
};

export function getT22BuySingleListingInstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: Array<number>;
      maxPrice: number | bigint;
  ...
  ) satisfies Encoder<T22BuySingleListingInstructionDataArgs>;
}

export function getT22BuySingleListingInstructionDataDecoder() {
  return getStructDecoder<T22BuySingleListingInstructionData>([
    ['discriminator', getArrayDecoder(getU8Decoder(), { size: 8 })],
    ['maxPrice', getU64Decoder()],
  ]) satisfies Decoder<T22BuySingleListingInstructionData>;
}

export function getT22BuySingleListingInstructionDataCodec(): Codec<
  T22BuySingleListingInstructionDataArgs,
  T22BuySingleListingInstructionData
> {
  return combineCodec(
    getT22BuySingleListingInstructionDataEncoder(),
    getT22BuySingleListingInstructionDataDecoder()
  );
}

export type T22BuySingleListingInput<
  TAccountTswap extends string,
  TAccountFeeVault extends string,
  TAccountSingleListing extends string,
  TAccountNftBuyerAcc extends string,
...
> = {
  ...
  maxPrice: T22BuySingleListingInstructionDataArgs['maxPrice'];
};

export type T22BuySingleListingInputWithSigners<
  TAccountTswap extends string,
  TAccountFeeVault extends string,
  TAccountSingleListing extends string,
  TAccountNftBuyerAcc extends string,
...
export function getT22BuySingleListingInstruction<
  TAccountTswap extends string,
  TAccountFeeVault extends string,
  TAccountSingleListing extends string,
  TAccountNftBuyerAcc extends string,
  ...
  TProgram extends string = 'TSWAPaqyCSx2KABk68Shruf4rp7CxcNi8hAsbdwmHbN'
>(
  input: T22BuySingleListingInputWithSigners<
    TAccountTswap,
    TAccountFeeVault,
    TAccountSingleListing,
    TAccountNftBuyerAcc,
    ...
    TAccountTakerBroker
  >
): T22BuySingleListingInstructionWithSigners<
  TProgram,
  TAccountTswap,
  TAccountFeeVault,
  TAccountSingleListing,
...
export function getT22BuySingleListingInstruction<
  ...
  TProgram extends string = 'TSWAPaqyCSx2KABk68Shruf4rp7CxcNi8hAsbdwmHbN'
>(
  input: T22BuySingleListingInput<
    TAccountTswap,
    TAccountFeeVault,
    TAccountSingleListing,
    TAccountNftBuyerAcc,
    ...
    TAccountTakerBroker
  >
): T22BuySingleListingInstruction<
  TProgram,
  TAccountTswap,
  TAccountFeeVault,
  TAccountSingleListing,
...
>(
  ...
  type AccountMetas = Parameters<
    typeof getT22BuySingleListingInstructionRaw<
      TProgram,
      TAccountTswap,
      TAccountFeeVault,
      TAccountSingleListing,
  ...
  const instruction = getT22BuySingleListingInstructionRaw(
    accountMetas as Record<keyof AccountMetas, IAccountMeta>,
    args as T22BuySingleListingInstructionDataArgs,
    programAddress
  );
...
export function getT22BuySingleListingInstructionRaw<
  TProgram extends string = 'TSWAPaqyCSx2KABk68Shruf4rp7CxcNi8hAsbdwmHbN',
  TAccountTswap extends string | IAccountMeta<string> = string,
  TAccountFeeVault extends string | IAccountMeta<string> = string,
  TAccountSingleListing extends string | IAccountMeta<string> = string,
...
>(
  ...
  args: T22BuySingleListingInstructionDataArgs,
  ...
  return {
    ...
    data: getT22BuySingleListingInstructionDataEncoder().encode(args),
    programAddress,
  } as T22BuySingleListingInstruction<
    TProgram,
    TAccountTswap,
    TAccountFeeVault,
    TAccountSingleListing,
...
export type ParsedT22BuySingleListingInstruction<
  TProgram extends string = 'TSWAPaqyCSx2KABk68Shruf4rp7CxcNi8hAsbdwmHbN',
...
> = {
  ...
  data: T22BuySingleListingInstructionData;
};

export function parseT22BuySingleListingInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedT22BuySingleListingInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getT22BuySingleListingInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
