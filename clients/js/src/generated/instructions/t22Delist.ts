...
export type T22DelistInstruction<
...
export type T22DelistInstructionWithSigners<
  TProgram extends string = 'TSWAPaqyCSx2KABk68Shruf4rp7CxcNi8hAsbdwmHbN',
  TAccountTswap extends string | IAccountMeta<string> = string,
  TAccountNftDest extends string | IAccountMeta<string> = string,
  TAccountNftMint extends string | IAccountMeta<string> = string,
...
export type T22DelistInstructionData = { discriminator: Array<number> };

export type T22DelistInstructionDataArgs = {};

export function getT22DelistInstructionDataEncoder() {
  return mapEncoder(
  ...
  ) satisfies Encoder<T22DelistInstructionDataArgs>;
}

export function getT22DelistInstructionDataDecoder() {
  return getStructDecoder<T22DelistInstructionData>([
    ['discriminator', getArrayDecoder(getU8Decoder(), { size: 8 })],
  ]) satisfies Decoder<T22DelistInstructionData>;
}

export function getT22DelistInstructionDataCodec(): Codec<
  T22DelistInstructionDataArgs,
  T22DelistInstructionData
> {
  return combineCodec(
    getT22DelistInstructionDataEncoder(),
    getT22DelistInstructionDataDecoder()
  );
}

export type T22DelistInput<
  TAccountTswap extends string,
  TAccountNftDest extends string,
  TAccountNftMint extends string,
  TAccountNftEscrow extends string,
...
export type T22DelistInputWithSigners<
  TAccountTswap extends string,
  TAccountNftDest extends string,
  TAccountNftMint extends string,
  TAccountNftEscrow extends string,
...
export function getT22DelistInstruction<
  TAccountTswap extends string,
  TAccountNftDest extends string,
  TAccountNftMint extends string,
  TAccountNftEscrow extends string,
  ...
  TProgram extends string = 'TSWAPaqyCSx2KABk68Shruf4rp7CxcNi8hAsbdwmHbN'
>(
  input: T22DelistInputWithSigners<
    TAccountTswap,
    TAccountNftDest,
    TAccountNftMint,
    TAccountNftEscrow,
    ...
    TAccountPayer
  >
): T22DelistInstructionWithSigners<
  TProgram,
  TAccountTswap,
  TAccountNftDest,
  TAccountNftMint,
...
>(
  ...
  type AccountMetas = Parameters<
    typeof getT22DelistInstructionRaw<
      TProgram,
      TAccountTswap,
      TAccountNftDest,
      TAccountNftMint,
  ...
  const instruction = getT22DelistInstructionRaw(
...
export function getT22DelistInstructionRaw<
  TProgram extends string = 'TSWAPaqyCSx2KABk68Shruf4rp7CxcNi8hAsbdwmHbN',
  TAccountTswap extends string | IAccountMeta<string> = string,
  TAccountNftDest extends string | IAccountMeta<string> = string,
  TAccountNftMint extends string | IAccountMeta<string> = string,
...
>(
  ...
  return {
    ...
    data: getT22DelistInstructionDataEncoder().encode({}),
    programAddress,
  } as T22DelistInstruction<
    TProgram,
    TAccountTswap,
    TAccountNftDest,
    TAccountNftMint,
...
export type ParsedT22DelistInstruction<
  TProgram extends string = 'TSWAPaqyCSx2KABk68Shruf4rp7CxcNi8hAsbdwmHbN',
...
> = {
  ...
  data: T22DelistInstructionData;
};

export function parseT22DelistInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedT22DelistInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getT22DelistInstructionDataDecoder().decode(instruction.data),
  };
}
