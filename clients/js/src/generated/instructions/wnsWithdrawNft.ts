...
export type WnsWithdrawNftInstructionWithSigners<
  TProgram extends string = 'TSWAPaqyCSx2KABk68Shruf4rp7CxcNi8hAsbdwmHbN',
  TAccountTswap extends string | IAccountMeta<string> = string,
  TAccountPool extends string | IAccountMeta<string> = string,
  TAccountWhitelist extends string | IAccountMeta<string> = string,
...
export function getWnsWithdrawNftInstructionDataEncoder() {
  return mapEncoder(
  ...
  ) satisfies Encoder<WnsWithdrawNftInstructionDataArgs>;
}

export function getWnsWithdrawNftInstructionDataDecoder() {
  return getStructDecoder<WnsWithdrawNftInstructionData>([
    ['discriminator', getArrayDecoder(getU8Decoder(), { size: 8 })],
    ['config', getPoolConfigDecoder()],
  ]) satisfies Decoder<WnsWithdrawNftInstructionData>;
}
...
export type WnsWithdrawNftInputWithSigners<
  TAccountTswap extends string,
  TAccountPool extends string,
  TAccountWhitelist extends string,
  TAccountNftDest extends string,
...
export function getWnsWithdrawNftInstruction<
  ...
  TProgram extends string = 'TSWAPaqyCSx2KABk68Shruf4rp7CxcNi8hAsbdwmHbN'
>(
  input: WnsWithdrawNftInputWithSigners<
    TAccountTswap,
    TAccountPool,
    TAccountWhitelist,
    TAccountNftDest,
    ...
    TAccountExtraMetas
  >
): WnsWithdrawNftInstructionWithSigners<
  TProgram,
  TAccountTswap,
  TAccountPool,
  TAccountWhitelist,
...
>(
  ...
  type AccountMetas = Parameters<
    typeof getWnsWithdrawNftInstructionRaw<
      TProgram,
      TAccountTswap,
      TAccountPool,
      TAccountWhitelist,
  ...
  const instruction = getWnsWithdrawNftInstructionRaw(
...
export function getWnsWithdrawNftInstructionRaw<
  TProgram extends string = 'TSWAPaqyCSx2KABk68Shruf4rp7CxcNi8hAsbdwmHbN',
  TAccountTswap extends string | IAccountMeta<string> = string,
  TAccountPool extends string | IAccountMeta<string> = string,
  TAccountWhitelist extends string | IAccountMeta<string> = string,
...
>(
  ...
  args: WnsWithdrawNftInstructionDataArgs,
  ...
  return {
    ...
    data: getWnsWithdrawNftInstructionDataEncoder().encode(args),
    programAddress,
