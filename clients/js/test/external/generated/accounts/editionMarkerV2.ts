...
export function getEditionMarkerV2AccountDataEncoder() {
  return getStructEncoder<EditionMarkerV2AccountDataArgs>([
    ['key', getKeyEncoder()],
    ['ledger', getBytesEncoder({ size: getU32Encoder() })],
  ]) satisfies Encoder<EditionMarkerV2AccountDataArgs>;
}

export function getEditionMarkerV2AccountDataDecoder() {
  return getStructDecoder<EditionMarkerV2AccountData>([
    ['key', getKeyDecoder()],
    ['ledger', getBytesDecoder({ size: getU32Decoder() })],
  ]) satisfies Decoder<EditionMarkerV2AccountData>;
}
