...
export function getMasterEditionAccountDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      key: KeyArgs;
      supply: number | bigint;
  ...
  ) satisfies Encoder<MasterEditionAccountDataArgs>;
}

export function getMasterEditionAccountDataDecoder() {
  return getStructDecoder<MasterEditionAccountData>([
    ['key', getKeyDecoder()],
    ['supply', getU64Decoder()],
    ['maxSupply', getOptionDecoder(getU64Decoder())],
  ]) satisfies Decoder<MasterEditionAccountData>;
}
