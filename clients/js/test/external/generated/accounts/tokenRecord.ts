...
export function getTokenRecordAccountDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      key: KeyArgs;
      bump: number;
  ...
  ) satisfies Encoder<TokenRecordAccountDataArgs>;
}

export function getTokenRecordAccountDataDecoder() {
  return getStructDecoder<TokenRecordAccountData>([
    ['key', getKeyDecoder()],
    ['bump', getU8Decoder()],
  ...
  ]) satisfies Decoder<TokenRecordAccountData>;
}
