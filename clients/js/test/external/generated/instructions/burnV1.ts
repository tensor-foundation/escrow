...
export function getBurnV1InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      burnV1Discriminator: number;
  ...
  ) satisfies Encoder<BurnV1InstructionDataArgs>;
}

export function getBurnV1InstructionDataDecoder() {
  return getStructDecoder<BurnV1InstructionData>([
    ['discriminator', getU8Decoder()],
    ['burnV1Discriminator', getU8Decoder()],
    ['amount', getU64Decoder()],
  ]) satisfies Decoder<BurnV1InstructionData>;
}
