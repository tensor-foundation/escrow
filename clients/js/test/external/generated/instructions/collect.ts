...
export function getCollectInstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{ discriminator: number }>([
      ['discriminator', getU8Encoder()],
    ]),
    (value) => ({ ...value, discriminator: 54 })
  ) satisfies Encoder<CollectInstructionDataArgs>;
}

export function getCollectInstructionDataDecoder() {
  return getStructDecoder<CollectInstructionData>([
    ['discriminator', getU8Decoder()],
  ]) satisfies Decoder<CollectInstructionData>;
}
