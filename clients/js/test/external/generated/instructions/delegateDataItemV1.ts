...
export type DelegateDataItemV1InstructionWithSigners<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountDelegate extends string | IAccountMeta<string> = string,
  TAccountMetadata extends string | IAccountMeta<string> = string,
...
export function getDelegateDataItemV1InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      delegateDataItemV1Discriminator: number;
  ...
  ) satisfies Encoder<DelegateDataItemV1InstructionDataArgs>;
}

export function getDelegateDataItemV1InstructionDataDecoder() {
  return getStructDecoder<DelegateDataItemV1InstructionData>([
    ['discriminator', getU8Decoder()],
    ['delegateDataItemV1Discriminator', getU8Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]) satisfies Decoder<DelegateDataItemV1InstructionData>;
}
...
export type DelegateDataItemV1AsyncInputWithSigners<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export async function getDelegateDataItemV1InstructionAsync<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: DelegateDataItemV1AsyncInputWithSigners<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
  ...
  DelegateDataItemV1InstructionWithSigners<
    TProgram,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
>(
  ...
  type AccountMetas = Parameters<
    typeof getDelegateDataItemV1InstructionRaw<
      TProgram,
      TAccountDelegateRecord,
      TAccountDelegate,
      TAccountMetadata,
  ...
  const instruction = getDelegateDataItemV1InstructionRaw(
...
export type DelegateDataItemV1InputWithSigners<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export function getDelegateDataItemV1Instruction<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: DelegateDataItemV1InputWithSigners<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
export function getDelegateDataItemV1InstructionRaw<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountDelegate extends string | IAccountMeta<string> = string,
  TAccountMetadata extends string | IAccountMeta<string> = string,
...
>(
  ...
  args: DelegateDataItemV1InstructionDataArgs,
  ...
  return {
    ...
    data: getDelegateDataItemV1InstructionDataEncoder().encode(args),
    programAddress,
