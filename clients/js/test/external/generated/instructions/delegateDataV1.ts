...
export type DelegateDataV1InstructionWithSigners<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountDelegate extends string | IAccountMeta<string> = string,
  TAccountMetadata extends string | IAccountMeta<string> = string,
...
export function getDelegateDataV1InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      delegateDataV1Discriminator: number;
  ...
  ) satisfies Encoder<DelegateDataV1InstructionDataArgs>;
}

export function getDelegateDataV1InstructionDataDecoder() {
  return getStructDecoder<DelegateDataV1InstructionData>([
    ['discriminator', getU8Decoder()],
    ['delegateDataV1Discriminator', getU8Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]) satisfies Decoder<DelegateDataV1InstructionData>;
}
...
export type DelegateDataV1InstructionExtraArgs = { updateAuthority: Address };
...
export type DelegateDataV1AsyncInputWithSigners<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export async function getDelegateDataV1InstructionAsync<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: DelegateDataV1AsyncInputWithSigners<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
  ...
  DelegateDataV1InstructionWithSigners<
    TProgram,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
>(
  ...
  type AccountMetas = Parameters<
    typeof getDelegateDataV1InstructionRaw<
      TProgram,
      TAccountDelegateRecord,
      TAccountDelegate,
      TAccountMetadata,
  ...
  const instruction = getDelegateDataV1InstructionRaw(
...
export type DelegateDataV1InputWithSigners<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export function getDelegateDataV1Instruction<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: DelegateDataV1InputWithSigners<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
export function getDelegateDataV1InstructionRaw<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountDelegate extends string | IAccountMeta<string> = string,
  TAccountMetadata extends string | IAccountMeta<string> = string,
...
>(
  ...
  args: DelegateDataV1InstructionDataArgs,
  ...
  return {
    ...
    data: getDelegateDataV1InstructionDataEncoder().encode(args),
    programAddress,
