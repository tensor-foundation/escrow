...
export type DelegateProgrammableConfigV1InstructionWithSigners<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountDelegate extends string | IAccountMeta<string> = string,
  TAccountMetadata extends string | IAccountMeta<string> = string,
...
export function getDelegateProgrammableConfigV1InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      delegateProgrammableConfigV1Discriminator: number;
  ...
  ) satisfies Encoder<DelegateProgrammableConfigV1InstructionDataArgs>;
}

export function getDelegateProgrammableConfigV1InstructionDataDecoder() {
  return getStructDecoder<DelegateProgrammableConfigV1InstructionData>([
  ...
  ]) satisfies Decoder<DelegateProgrammableConfigV1InstructionData>;
}
...
export type DelegateProgrammableConfigV1AsyncInputWithSigners<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export async function getDelegateProgrammableConfigV1InstructionAsync<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: DelegateProgrammableConfigV1AsyncInputWithSigners<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
  ...
  DelegateProgrammableConfigV1InstructionWithSigners<
    TProgram,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
>(
  ...
  type AccountMetas = Parameters<
    typeof getDelegateProgrammableConfigV1InstructionRaw<
      TProgram,
      TAccountDelegateRecord,
      TAccountDelegate,
      TAccountMetadata,
  ...
  const instruction = getDelegateProgrammableConfigV1InstructionRaw(
...
export type DelegateProgrammableConfigV1InputWithSigners<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export function getDelegateProgrammableConfigV1Instruction<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: DelegateProgrammableConfigV1InputWithSigners<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
export function getDelegateProgrammableConfigV1InstructionRaw<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountDelegate extends string | IAccountMeta<string> = string,
  TAccountMetadata extends string | IAccountMeta<string> = string,
...
>(
  ...
  args: DelegateProgrammableConfigV1InstructionDataArgs,
  ...
  return {
    ...
    data: getDelegateProgrammableConfigV1InstructionDataEncoder().encode(args),
    programAddress,
