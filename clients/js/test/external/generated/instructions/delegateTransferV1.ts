...
export type DelegateTransferV1InstructionWithSigners<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountDelegate extends string | IAccountMeta<string> = string,
  TAccountMetadata extends string | IAccountMeta<string> = string,
...
export function getDelegateTransferV1InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      delegateTransferV1Discriminator: number;
  ...
  ) satisfies Encoder<DelegateTransferV1InstructionDataArgs>;
}

export function getDelegateTransferV1InstructionDataDecoder() {
  return getStructDecoder<DelegateTransferV1InstructionData>([
    ['discriminator', getU8Decoder()],
    ['delegateTransferV1Discriminator', getU8Decoder()],
    ['amount', getU64Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]) satisfies Decoder<DelegateTransferV1InstructionData>;
}
...
export type DelegateTransferV1InstructionExtraArgs = { tokenOwner: Address };
...
export type DelegateTransferV1AsyncInputWithSigners<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export async function getDelegateTransferV1InstructionAsync<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: DelegateTransferV1AsyncInputWithSigners<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
  ...
  DelegateTransferV1InstructionWithSigners<
    TProgram,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
>(
  ...
  type AccountMetas = Parameters<
    typeof getDelegateTransferV1InstructionRaw<
      TProgram,
      TAccountDelegateRecord,
      TAccountDelegate,
      TAccountMetadata,
  ...
  const instruction = getDelegateTransferV1InstructionRaw(
...
export type DelegateTransferV1InputWithSigners<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export function getDelegateTransferV1Instruction<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: DelegateTransferV1InputWithSigners<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
export function getDelegateTransferV1InstructionRaw<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountDelegate extends string | IAccountMeta<string> = string,
  TAccountMetadata extends string | IAccountMeta<string> = string,
...
>(
  ...
  args: DelegateTransferV1InstructionDataArgs,
  ...
  return {
    ...
    data: getDelegateTransferV1InstructionDataEncoder().encode(args),
    programAddress,
