...
export function getLockV1InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      lockV1Discriminator: number;
  ...
  ) satisfies Encoder<LockV1InstructionDataArgs>;
}

export function getLockV1InstructionDataDecoder() {
  return getStructDecoder<LockV1InstructionData>([
    ['discriminator', getU8Decoder()],
    ['lockV1Discriminator', getU8Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]) satisfies Decoder<LockV1InstructionData>;
}
