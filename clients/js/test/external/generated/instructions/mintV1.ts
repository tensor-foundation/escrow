...
export function getMintV1InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      mintV1Discriminator: number;
  ...
  ) satisfies Encoder<MintV1InstructionDataArgs>;
}

export function getMintV1InstructionDataDecoder() {
  return getStructDecoder<MintV1InstructionData>([
    ['discriminator', getU8Decoder()],
    ['mintV1Discriminator', getU8Decoder()],
    ['amount', getU64Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]) satisfies Decoder<MintV1InstructionData>;
}
