...
export function getPrintV1InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      printV1Discriminator: number;
  ...
  ) satisfies Encoder<PrintV1InstructionDataArgs>;
}

export function getPrintV1InstructionDataDecoder() {
  return getStructDecoder<PrintV1InstructionData>([
    ['discriminator', getU8Decoder()],
    ['printV1Discriminator', getU8Decoder()],
    ['editionNumber', getU64Decoder()],
  ]) satisfies Decoder<PrintV1InstructionData>;
}
