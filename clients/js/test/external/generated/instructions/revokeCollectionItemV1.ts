...
export type RevokeCollectionItemV1InstructionWithSigners<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountDelegate extends string | IAccountMeta<string> = string,
  TAccountMetadata extends string | IAccountMeta<string> = string,
...
export function getRevokeCollectionItemV1InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      revokeCollectionItemV1Discriminator: number;
  ...
  ) satisfies Encoder<RevokeCollectionItemV1InstructionDataArgs>;
}

export function getRevokeCollectionItemV1InstructionDataDecoder() {
  return getStructDecoder<RevokeCollectionItemV1InstructionData>([
    ['discriminator', getU8Decoder()],
    ['revokeCollectionItemV1Discriminator', getU8Decoder()],
  ]) satisfies Decoder<RevokeCollectionItemV1InstructionData>;
}
...
export type RevokeCollectionItemV1AsyncInputWithSigners<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export async function getRevokeCollectionItemV1InstructionAsync<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: RevokeCollectionItemV1AsyncInputWithSigners<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
  ...
  RevokeCollectionItemV1InstructionWithSigners<
    TProgram,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
>(
  ...
  type AccountMetas = Parameters<
    typeof getRevokeCollectionItemV1InstructionRaw<
      TProgram,
      TAccountDelegateRecord,
      TAccountDelegate,
      TAccountMetadata,
  ...
  const instruction = getRevokeCollectionItemV1InstructionRaw(
...
export type RevokeCollectionItemV1InputWithSigners<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export function getRevokeCollectionItemV1Instruction<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: RevokeCollectionItemV1InputWithSigners<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
export function getRevokeCollectionItemV1InstructionRaw<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountDelegate extends string | IAccountMeta<string> = string,
  TAccountMetadata extends string | IAccountMeta<string> = string,
