...
export function getUnlockV1InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      unlockV1Discriminator: number;
  ...
  ) satisfies Encoder<UnlockV1InstructionDataArgs>;
}

export function getUnlockV1InstructionDataDecoder() {
  return getStructDecoder<UnlockV1InstructionData>([
    ['discriminator', getU8Decoder()],
    ['unlockV1Discriminator', getU8Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]) satisfies Decoder<UnlockV1InstructionData>;
}
