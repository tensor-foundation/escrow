...
export function getUnverifyCollectionV1InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      unverifyCollectionV1Discriminator: number;
  ...
  ) satisfies Encoder<UnverifyCollectionV1InstructionDataArgs>;
}

export function getUnverifyCollectionV1InstructionDataDecoder() {
  return getStructDecoder<UnverifyCollectionV1InstructionData>([
    ['discriminator', getU8Decoder()],
    ['unverifyCollectionV1Discriminator', getU8Decoder()],
  ]) satisfies Decoder<UnverifyCollectionV1InstructionData>;
}
