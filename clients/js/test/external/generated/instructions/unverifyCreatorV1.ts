...
export function getUnverifyCreatorV1InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      unverifyCreatorV1Discriminator: number;
  ...
  ) satisfies Encoder<UnverifyCreatorV1InstructionDataArgs>;
}

export function getUnverifyCreatorV1InstructionDataDecoder() {
  return getStructDecoder<UnverifyCreatorV1InstructionData>([
    ['discriminator', getU8Decoder()],
    ['unverifyCreatorV1Discriminator', getU8Decoder()],
  ]) satisfies Decoder<UnverifyCreatorV1InstructionData>;
}
