...
export type UpdateAsAuthorityItemDelegateV2InstructionWithSigners<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountAuthority extends string | IAccountMeta<string> = string,
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountToken extends string | IAccountMeta<string> = string,
...
export function getUpdateAsAuthorityItemDelegateV2InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      updateAsAuthorityItemDelegateV2Discriminator: number;
  ...
  ) satisfies Encoder<UpdateAsAuthorityItemDelegateV2InstructionDataArgs>;
}

export function getUpdateAsAuthorityItemDelegateV2InstructionDataDecoder() {
  return getStructDecoder<UpdateAsAuthorityItemDelegateV2InstructionData>([
  ...
  ]) satisfies Decoder<UpdateAsAuthorityItemDelegateV2InstructionData>;
}
...
export type UpdateAsAuthorityItemDelegateV2AsyncInputWithSigners<
  TAccountAuthority extends string,
  TAccountDelegateRecord extends string,
  TAccountToken extends string,
  TAccountMint extends string,
...
export async function getUpdateAsAuthorityItemDelegateV2InstructionAsync<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: UpdateAsAuthorityItemDelegateV2AsyncInputWithSigners<
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
    TAccountMint,
  ...
  UpdateAsAuthorityItemDelegateV2InstructionWithSigners<
    TProgram,
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
...
>(
  ...
  type AccountMetas = Parameters<
    typeof getUpdateAsAuthorityItemDelegateV2InstructionRaw<
      TProgram,
      TAccountAuthority,
      TAccountDelegateRecord,
      TAccountToken,
  ...
  const instruction = getUpdateAsAuthorityItemDelegateV2InstructionRaw(
...
export type UpdateAsAuthorityItemDelegateV2InputWithSigners<
  TAccountAuthority extends string,
  TAccountDelegateRecord extends string,
  TAccountToken extends string,
  TAccountMint extends string,
...
export function getUpdateAsAuthorityItemDelegateV2Instruction<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: UpdateAsAuthorityItemDelegateV2InputWithSigners<
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
    TAccountMint,
...
export function getUpdateAsAuthorityItemDelegateV2InstructionRaw<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountAuthority extends string | IAccountMeta<string> = string,
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountToken extends string | IAccountMeta<string> = string,
...
>(
  ...
  args: UpdateAsAuthorityItemDelegateV2InstructionDataArgs,
