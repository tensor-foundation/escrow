...
export type UpdateAsCollectionDelegateV2InstructionWithSigners<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountAuthority extends string | IAccountMeta<string> = string,
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountToken extends string | IAccountMeta<string> = string,
...
export function getUpdateAsCollectionDelegateV2InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      updateAsCollectionDelegateV2Discriminator: number;
  ...
  ) satisfies Encoder<UpdateAsCollectionDelegateV2InstructionDataArgs>;
}

export function getUpdateAsCollectionDelegateV2InstructionDataDecoder() {
  return getStructDecoder<UpdateAsCollectionDelegateV2InstructionData>([
  ...
  ]) satisfies Decoder<UpdateAsCollectionDelegateV2InstructionData>;
}
...
export type UpdateAsCollectionDelegateV2AsyncInputWithSigners<
  TAccountAuthority extends string,
  TAccountDelegateRecord extends string,
  TAccountToken extends string,
  TAccountMint extends string,
...
export async function getUpdateAsCollectionDelegateV2InstructionAsync<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: UpdateAsCollectionDelegateV2AsyncInputWithSigners<
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
    TAccountMint,
  ...
  UpdateAsCollectionDelegateV2InstructionWithSigners<
    TProgram,
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
...
>(
  ...
  type AccountMetas = Parameters<
    typeof getUpdateAsCollectionDelegateV2InstructionRaw<
      TProgram,
      TAccountAuthority,
      TAccountDelegateRecord,
      TAccountToken,
  ...
  const instruction = getUpdateAsCollectionDelegateV2InstructionRaw(
...
export type UpdateAsCollectionDelegateV2InputWithSigners<
  TAccountAuthority extends string,
  TAccountDelegateRecord extends string,
  TAccountToken extends string,
  TAccountMint extends string,
...
export function getUpdateAsCollectionDelegateV2Instruction<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: UpdateAsCollectionDelegateV2InputWithSigners<
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
    TAccountMint,
...
export function getUpdateAsCollectionDelegateV2InstructionRaw<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountAuthority extends string | IAccountMeta<string> = string,
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountToken extends string | IAccountMeta<string> = string,
...
>(
  ...
  args: UpdateAsCollectionDelegateV2InstructionDataArgs,
  ...
  return {
    ...
    data: getUpdateAsCollectionDelegateV2InstructionDataEncoder().encode(args),
    programAddress,
