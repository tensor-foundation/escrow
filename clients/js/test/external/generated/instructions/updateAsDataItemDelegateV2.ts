...
export type UpdateAsDataItemDelegateV2InstructionWithSigners<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountAuthority extends string | IAccountMeta<string> = string,
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountToken extends string | IAccountMeta<string> = string,
...
export function getUpdateAsDataItemDelegateV2InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      updateAsDataItemDelegateV2Discriminator: number;
  ...
  ) satisfies Encoder<UpdateAsDataItemDelegateV2InstructionDataArgs>;
}

export function getUpdateAsDataItemDelegateV2InstructionDataDecoder() {
  return getStructDecoder<UpdateAsDataItemDelegateV2InstructionData>([
  ...
  ]) satisfies Decoder<UpdateAsDataItemDelegateV2InstructionData>;
}
...
export type UpdateAsDataItemDelegateV2AsyncInputWithSigners<
  TAccountAuthority extends string,
  TAccountDelegateRecord extends string,
  TAccountToken extends string,
  TAccountMint extends string,
...
export async function getUpdateAsDataItemDelegateV2InstructionAsync<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: UpdateAsDataItemDelegateV2AsyncInputWithSigners<
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
    TAccountMint,
  ...
  UpdateAsDataItemDelegateV2InstructionWithSigners<
    TProgram,
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
...
>(
  ...
  type AccountMetas = Parameters<
    typeof getUpdateAsDataItemDelegateV2InstructionRaw<
      TProgram,
      TAccountAuthority,
      TAccountDelegateRecord,
      TAccountToken,
  ...
  const instruction = getUpdateAsDataItemDelegateV2InstructionRaw(
...
export type UpdateAsDataItemDelegateV2InputWithSigners<
  TAccountAuthority extends string,
  TAccountDelegateRecord extends string,
  TAccountToken extends string,
  TAccountMint extends string,
...
export function getUpdateAsDataItemDelegateV2Instruction<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: UpdateAsDataItemDelegateV2InputWithSigners<
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
    TAccountMint,
...
export function getUpdateAsDataItemDelegateV2InstructionRaw<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountAuthority extends string | IAccountMeta<string> = string,
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountToken extends string | IAccountMeta<string> = string,
...
>(
  ...
  args: UpdateAsDataItemDelegateV2InstructionDataArgs,
  ...
  return {
    ...
    data: getUpdateAsDataItemDelegateV2InstructionDataEncoder().encode(args),
    programAddress,
