...
export type UpdateAsProgrammableConfigDelegateV2InstructionWithSigners<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountAuthority extends string | IAccountMeta<string> = string,
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountToken extends string | IAccountMeta<string> = string,
...
export function getUpdateAsProgrammableConfigDelegateV2InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      updateAsProgrammableConfigDelegateV2Discriminator: number;
  ...
  ) satisfies Encoder<UpdateAsProgrammableConfigDelegateV2InstructionDataArgs>;
}

export function getUpdateAsProgrammableConfigDelegateV2InstructionDataDecoder() {
  return getStructDecoder<UpdateAsProgrammableConfigDelegateV2InstructionData>([
  ...
  ]) satisfies Decoder<UpdateAsProgrammableConfigDelegateV2InstructionData>;
}
...
export type UpdateAsProgrammableConfigDelegateV2AsyncInputWithSigners<
  TAccountAuthority extends string,
  TAccountDelegateRecord extends string,
  TAccountToken extends string,
  TAccountMint extends string,
...
export async function getUpdateAsProgrammableConfigDelegateV2InstructionAsync<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: UpdateAsProgrammableConfigDelegateV2AsyncInputWithSigners<
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
    TAccountMint,
  ...
  UpdateAsProgrammableConfigDelegateV2InstructionWithSigners<
    TProgram,
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
...
>(
  ...
  type AccountMetas = Parameters<
    typeof getUpdateAsProgrammableConfigDelegateV2InstructionRaw<
      TProgram,
      TAccountAuthority,
      TAccountDelegateRecord,
      TAccountToken,
  ...
  const instruction = getUpdateAsProgrammableConfigDelegateV2InstructionRaw(
...
export type UpdateAsProgrammableConfigDelegateV2InputWithSigners<
  TAccountAuthority extends string,
  TAccountDelegateRecord extends string,
  TAccountToken extends string,
  TAccountMint extends string,
...
export function getUpdateAsProgrammableConfigDelegateV2Instruction<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: UpdateAsProgrammableConfigDelegateV2InputWithSigners<
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
    TAccountMint,
...
export function getUpdateAsProgrammableConfigDelegateV2InstructionRaw<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountAuthority extends string | IAccountMeta<string> = string,
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountToken extends string | IAccountMeta<string> = string,
...
>(
  ...
  args: UpdateAsProgrammableConfigDelegateV2InstructionDataArgs,
