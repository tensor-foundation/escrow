...
export type UpdateAsUpdateAuthorityV2InstructionWithSigners<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountAuthority extends string | IAccountMeta<string> = string,
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountToken extends string | IAccountMeta<string> = string,
...
export function getUpdateAsUpdateAuthorityV2InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      updateAsUpdateAuthorityV2Discriminator: number;
  ...
  ) satisfies Encoder<UpdateAsUpdateAuthorityV2InstructionDataArgs>;
}

export function getUpdateAsUpdateAuthorityV2InstructionDataDecoder() {
  return getStructDecoder<UpdateAsUpdateAuthorityV2InstructionData>([
  ...
  ]) satisfies Decoder<UpdateAsUpdateAuthorityV2InstructionData>;
}
...
export type UpdateAsUpdateAuthorityV2AsyncInputWithSigners<
  TAccountAuthority extends string,
  TAccountDelegateRecord extends string,
  TAccountToken extends string,
  TAccountMint extends string,
...
export async function getUpdateAsUpdateAuthorityV2InstructionAsync<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: UpdateAsUpdateAuthorityV2AsyncInputWithSigners<
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
    TAccountMint,
  ...
  UpdateAsUpdateAuthorityV2InstructionWithSigners<
    TProgram,
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
...
>(
  ...
  type AccountMetas = Parameters<
    typeof getUpdateAsUpdateAuthorityV2InstructionRaw<
      TProgram,
      TAccountAuthority,
      TAccountDelegateRecord,
      TAccountToken,
  ...
  const instruction = getUpdateAsUpdateAuthorityV2InstructionRaw(
...
export type UpdateAsUpdateAuthorityV2InputWithSigners<
  TAccountAuthority extends string,
  TAccountDelegateRecord extends string,
  TAccountToken extends string,
  TAccountMint extends string,
...
export function getUpdateAsUpdateAuthorityV2Instruction<
  ...
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s'
>(
  input: UpdateAsUpdateAuthorityV2InputWithSigners<
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
    TAccountMint,
...
export function getUpdateAsUpdateAuthorityV2InstructionRaw<
  TProgram extends string = 'metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s',
  TAccountAuthority extends string | IAccountMeta<string> = string,
  TAccountDelegateRecord extends string | IAccountMeta<string> = string,
  TAccountToken extends string | IAccountMeta<string> = string,
...
>(
  ...
  args: UpdateAsUpdateAuthorityV2InstructionDataArgs,
  ...
  return {
    ...
    data: getUpdateAsUpdateAuthorityV2InstructionDataEncoder().encode(args),
    programAddress,
