...
export function getVerifyCollectionV1InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      verifyCollectionV1Discriminator: number;
  ...
  ) satisfies Encoder<VerifyCollectionV1InstructionDataArgs>;
}

export function getVerifyCollectionV1InstructionDataDecoder() {
  return getStructDecoder<VerifyCollectionV1InstructionData>([
    ['discriminator', getU8Decoder()],
    ['verifyCollectionV1Discriminator', getU8Decoder()],
  ]) satisfies Decoder<VerifyCollectionV1InstructionData>;
}
