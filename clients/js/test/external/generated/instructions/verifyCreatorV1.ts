...
export function getVerifyCreatorV1InstructionDataEncoder() {
  return mapEncoder(
    getStructEncoder<{
      discriminator: number;
      verifyCreatorV1Discriminator: number;
  ...
  ) satisfies Encoder<VerifyCreatorV1InstructionDataArgs>;
}

export function getVerifyCreatorV1InstructionDataDecoder() {
  return getStructDecoder<VerifyCreatorV1InstructionData>([
    ['discriminator', getU8Decoder()],
    ['verifyCreatorV1Discriminator', getU8Decoder()],
  ]) satisfies Decoder<VerifyCreatorV1InstructionData>;
}
