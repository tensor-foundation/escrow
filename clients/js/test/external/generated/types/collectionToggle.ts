...
export function getCollectionToggleEncoder() {
  return getDataEnumEncoder<CollectionToggleArgs>([
    ['None', getUnitEncoder()],
    ['Clear', getUnitEncoder()],
    [
      'Set',
      getStructEncoder<GetDataEnumKindContent<CollectionToggleArgs, 'Set'>>([
        ['fields', getTupleEncoder([getCollectionEncoder()])],
      ]),
    ],
  ]) satisfies Encoder<CollectionToggleArgs>;
}

export function getCollectionToggleDecoder() {
  return getDataEnumDecoder<CollectionToggle>([
    ['None', getUnitDecoder()],
    ['Clear', getUnitDecoder()],
    [
      'Set',
      getStructDecoder<GetDataEnumKindContent<CollectionToggle, 'Set'>>([
        ['fields', getTupleDecoder([getCollectionDecoder()])],
      ]),
    ],
  ]) satisfies Decoder<CollectionToggle>;
}
