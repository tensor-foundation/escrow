...
export function getCreateArgsEncoder() {
  return getDataEnumEncoder<CreateArgsArgs>([
    [
      'V1',
      mapEncoder(
        getStructEncoder<{
  ...
  ]) satisfies Encoder<CreateArgsArgs>;
}

export function getCreateArgsDecoder() {
  return getDataEnumDecoder<CreateArgs>([
    [
      'V1',
      getStructDecoder<GetDataEnumKindContent<CreateArgs, 'V1'>>([
