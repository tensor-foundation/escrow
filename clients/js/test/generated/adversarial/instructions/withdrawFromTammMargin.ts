...
export const WITHDRAW_FROM_TAMM_MARGIN_DISCRIMINATOR = new Uint8Array([
  19, 157, 14, 131, 206, 43, 39, 247,
]);

export function getWithdrawFromTammMarginDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    WITHDRAW_FROM_TAMM_MARGIN_DISCRIMINATOR
  );
}
...
export function getWithdrawFromTammMarginInstructionDataEncoder(): Encoder<WithdrawFromTammMarginInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: WITHDRAW_FROM_TAMM_MARGIN_DISCRIMINATOR,
    })
  );
}
