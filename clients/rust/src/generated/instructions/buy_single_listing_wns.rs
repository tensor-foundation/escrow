...
/// Accounts.
pub struct BuySingleListingWns {
...
impl BuySingleListingWns {
    pub fn instruction(
        &self,
        args: BuySingleListingWnsInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = BuySingleListingWnsInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct BuySingleListingWnsInstructionData {
    discriminator: [u8; 8],
}

impl BuySingleListingWnsInstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct BuySingleListingWnsInstructionArgs {
    pub max_price: u64,
}

/// Instruction builder for `BuySingleListingWns`.
///
/// ### Accounts:
///
///   0. `[]` tswap
///   1. `[writable]` fee_vault
///   2. `[writable]` single_listing
...
///   16. `[]` extra_metas
#[derive(Default)]
pub struct BuySingleListingWnsBuilder {
...
impl BuySingleListingWnsBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = BuySingleListingWns {
        ...
        let args = BuySingleListingWnsInstructionArgs {
...
/// `buy_single_listing_wns` CPI accounts.
pub struct BuySingleListingWnsCpiAccounts<'a, 'b> {
...
/// `buy_single_listing_wns` CPI instruction.
pub struct BuySingleListingWnsCpi<'a, 'b> {
    ...
    pub __args: BuySingleListingWnsInstructionArgs,
}

impl<'a, 'b> BuySingleListingWnsCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: BuySingleListingWnsCpiAccounts<'a, 'b>,
        args: BuySingleListingWnsInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `BuySingleListingWns` via CPI.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
///   15. `[]` distribution_program
///   16. `[]` extra_metas
pub struct BuySingleListingWnsCpiBuilder<'a, 'b> {
    instruction: Box<BuySingleListingWnsCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> BuySingleListingWnsCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(BuySingleListingWnsCpiBuilderInstruction {
            __program: program,
            tswap: None,
            fee_vault: None,
            single_listing: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = BuySingleListingWnsCpi {
...
struct BuySingleListingWnsCpiBuilderInstruction<'a, 'b> {
