...
pub struct SellNftTradePoolWnsInstructionData {
    discriminator: [u8; 8],
}
...
///   16. `[writable]` taker_broker
///   17. `[writable]` approve_account
///   18. `[writable]` distribution
///   19. `[]` wns_program
///   20. `[]` distribution_program
///   21. `[]` extra_metas
#[derive(Default)]
