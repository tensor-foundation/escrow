...
impl T22BuyNft {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = T22BuyNftInstructionData::new().try_to_vec().unwrap();
...
struct T22BuyNftInstructionData {
    discriminator: [u8; 8],
}

impl T22BuyNftInstructionData {
    fn new() -> Self {
        Self {
...
pub struct T22BuyNftInstructionArgs {
    pub config: PoolConfig,
    pub max_price: u64,
}

/// Instruction builder for `T22BuyNft`.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
impl T22BuyNftBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = T22BuyNftInstructionArgs {
...
/// `t22_buy_nft` CPI accounts.
pub struct T22BuyNftCpiAccounts<'a, 'b> {
...
/// `t22_buy_nft` CPI instruction.
pub struct T22BuyNftCpi<'a, 'b> {
    ...
    pub __args: T22BuyNftInstructionArgs,
}

impl<'a, 'b> T22BuyNftCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: T22BuyNftCpiAccounts<'a, 'b>,
        args: T22BuyNftInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `T22BuyNft` via CPI.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
///   14. `[writable]` margin_account
///   15. `[writable]` taker_broker
pub struct T22BuyNftCpiBuilder<'a, 'b> {
    instruction: Box<T22BuyNftCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> T22BuyNftCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(T22BuyNftCpiBuilderInstruction {
            __program: program,
            tswap: None,
            fee_vault: None,
            pool: None,
...
struct T22BuyNftCpiBuilderInstruction<'a, 'b> {
