...
/// Accounts.
pub struct T22BuySingleListing {
...
impl T22BuySingleListing {
    pub fn instruction(
        &self,
        args: T22BuySingleListingInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = T22BuySingleListingInstructionData::new()
            .try_to_vec()
            .unwrap();
...
struct T22BuySingleListingInstructionData {
    discriminator: [u8; 8],
}

impl T22BuySingleListingInstructionData {
    fn new() -> Self {
        Self {
...
pub struct T22BuySingleListingInstructionArgs {
    pub max_price: u64,
}

/// Instruction builder for `T22BuySingleListing`.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
#[derive(Default)]
pub struct T22BuySingleListingBuilder {
...
impl T22BuySingleListingBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = T22BuySingleListing {
        ...
        let args = T22BuySingleListingInstructionArgs {
...
/// `t22_buy_single_listing` CPI accounts.
pub struct T22BuySingleListingCpiAccounts<'a, 'b> {
...
/// `t22_buy_single_listing` CPI instruction.
pub struct T22BuySingleListingCpi<'a, 'b> {
    ...
    pub __args: T22BuySingleListingInstructionArgs,
}

impl<'a, 'b> T22BuySingleListingCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: T22BuySingleListingCpiAccounts<'a, 'b>,
        args: T22BuySingleListingInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `T22BuySingleListing` via CPI.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
///   10. `[]` system_program
///   11. `[writable]` taker_broker
pub struct T22BuySingleListingCpiBuilder<'a, 'b> {
    instruction: Box<T22BuySingleListingCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> T22BuySingleListingCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(T22BuySingleListingCpiBuilderInstruction {
            __program: program,
            tswap: None,
            fee_vault: None,
            single_listing: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = T22BuySingleListingCpi {
...
struct T22BuySingleListingCpiBuilderInstruction<'a, 'b> {
