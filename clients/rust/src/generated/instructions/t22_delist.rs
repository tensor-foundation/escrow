...
impl T22Delist {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = T22DelistInstructionData::new().try_to_vec().unwrap();
...
struct T22DelistInstructionData {
    discriminator: [u8; 8],
}

impl T22DelistInstructionData {
    fn new() -> Self {
        Self {
...
/// Instruction builder for `T22Delist`.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
/// `t22_delist` CPI accounts.
pub struct T22DelistCpiAccounts<'a, 'b> {
...
/// `t22_delist` CPI instruction.
pub struct T22DelistCpi<'a, 'b> {
...
impl<'a, 'b> T22DelistCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: T22DelistCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `T22Delist` via CPI.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
///   9. `[]` associated_token_program
///   10. `[writable, signer]` payer
pub struct T22DelistCpiBuilder<'a, 'b> {
    instruction: Box<T22DelistCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> T22DelistCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(T22DelistCpiBuilderInstruction {
            __program: program,
            tswap: None,
            nft_dest: None,
            nft_mint: None,
...
struct T22DelistCpiBuilderInstruction<'a, 'b> {
