...
impl T22DepositNft {
    pub fn instruction(
        &self,
        args: T22DepositNftInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = T22DepositNftInstructionData::new().try_to_vec().unwrap();
...
struct T22DepositNftInstructionData {
    discriminator: [u8; 8],
}

impl T22DepositNftInstructionData {
    fn new() -> Self {
        Self {
...
pub struct T22DepositNftInstructionArgs {
    pub config: PoolConfig,
}

/// Instruction builder for `T22DepositNft`.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
///   10. `[]` mint_proof
#[derive(Default)]
pub struct T22DepositNftBuilder {
...
impl T22DepositNftBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = T22DepositNftInstructionArgs {
...
/// `t22_deposit_nft` CPI accounts.
pub struct T22DepositNftCpiAccounts<'a, 'b> {
...
/// `t22_deposit_nft` CPI instruction.
pub struct T22DepositNftCpi<'a, 'b> {
    ...
    pub __args: T22DepositNftInstructionArgs,
}

impl<'a, 'b> T22DepositNftCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: T22DepositNftCpiAccounts<'a, 'b>,
        args: T22DepositNftInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `T22DepositNft` via CPI.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
///   9. `[]` system_program
///   10. `[]` mint_proof
pub struct T22DepositNftCpiBuilder<'a, 'b> {
    instruction: Box<T22DepositNftCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> T22DepositNftCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(T22DepositNftCpiBuilderInstruction {
            __program: program,
            tswap: None,
            pool: None,
            whitelist: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = T22DepositNftCpi {
...
struct T22DepositNftCpiBuilderInstruction<'a, 'b> {
