...
/// Accounts.
pub struct T22SellNftTokenPool {
...
impl T22SellNftTokenPool {
    pub fn instruction(
        &self,
        args: T22SellNftTokenPoolInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = T22SellNftTokenPoolInstructionData::new()
            .try_to_vec()
            .unwrap();
...
struct T22SellNftTokenPoolInstructionData {
    discriminator: [u8; 8],
}

impl T22SellNftTokenPoolInstructionData {
    fn new() -> Self {
        Self {
...
pub struct T22SellNftTokenPoolInstructionArgs {
    pub config: PoolConfig,
    pub min_price: u64,
}

/// Instruction builder for `T22SellNftTokenPool`.
///
/// ### Accounts:
///
///   0. `[]` shared
...
#[derive(Default)]
pub struct T22SellNftTokenPoolBuilder {
...
impl T22SellNftTokenPoolBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = T22SellNftTokenPool {
        ...
        let args = T22SellNftTokenPoolInstructionArgs {
...
/// `t22_sell_nft_token_pool` CPI accounts.
pub struct T22SellNftTokenPoolCpiAccounts<'a, 'b> {
...
/// `t22_sell_nft_token_pool` CPI instruction.
pub struct T22SellNftTokenPoolCpi<'a, 'b> {
    ...
    pub __args: T22SellNftTokenPoolInstructionArgs,
}

impl<'a, 'b> T22SellNftTokenPoolCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: T22SellNftTokenPoolCpiAccounts<'a, 'b>,
        args: T22SellNftTokenPoolInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `T22SellNftTokenPool` via CPI.
///
/// ### Accounts:
///
///   0. `[]` shared
...
///   5. `[writable]` margin_account
///   6. `[writable]` taker_broker
pub struct T22SellNftTokenPoolCpiBuilder<'a, 'b> {
    instruction: Box<T22SellNftTokenPoolCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> T22SellNftTokenPoolCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(T22SellNftTokenPoolCpiBuilderInstruction {
            __program: program,
            shared: None,
            owner_ata_acc: None,
            token_program: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = T22SellNftTokenPoolCpi {
...
struct T22SellNftTokenPoolCpiBuilderInstruction<'a, 'b> {
