...
impl T22WithdrawNft {
    pub fn instruction(
        &self,
        args: T22WithdrawNftInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = T22WithdrawNftInstructionData::new().try_to_vec().unwrap();
...
struct T22WithdrawNftInstructionData {
    discriminator: [u8; 8],
}

impl T22WithdrawNftInstructionData {
    fn new() -> Self {
        Self {
...
pub struct T22WithdrawNftInstructionArgs {
    pub config: PoolConfig,
}

/// Instruction builder for `T22WithdrawNft`.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
#[derive(Default)]
pub struct T22WithdrawNftBuilder {
...
impl T22WithdrawNftBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = T22WithdrawNftInstructionArgs {
...
/// `t22_withdraw_nft` CPI accounts.
pub struct T22WithdrawNftCpiAccounts<'a, 'b> {
...
/// `t22_withdraw_nft` CPI instruction.
pub struct T22WithdrawNftCpi<'a, 'b> {
    ...
    pub __args: T22WithdrawNftInstructionArgs,
}

impl<'a, 'b> T22WithdrawNftCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: T22WithdrawNftCpiAccounts<'a, 'b>,
        args: T22WithdrawNftInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `T22WithdrawNft` via CPI.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
///   9. `[]` associated_token_program
///   10. `[]` system_program
pub struct T22WithdrawNftCpiBuilder<'a, 'b> {
    instruction: Box<T22WithdrawNftCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> T22WithdrawNftCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(T22WithdrawNftCpiBuilderInstruction {
            __program: program,
            tswap: None,
            pool: None,
            whitelist: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = T22WithdrawNftCpi {
...
struct T22WithdrawNftCpiBuilderInstruction<'a, 'b> {
