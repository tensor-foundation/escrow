...
impl WithdrawMarginAccountCpiTlock {
    pub fn instruction(
        &self,
        args: WithdrawMarginAccountCpiTlockInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = WithdrawMarginAccountCpiTlockInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct WithdrawMarginAccountCpiTlockInstructionData {
    discriminator: [u8; 8],
}

impl WithdrawMarginAccountCpiTlockInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for WithdrawMarginAccountCpiTlockInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct WithdrawMarginAccountCpiTlockInstructionArgs {
    pub bump: u8,
    pub order_id: [u8; 32],
    pub lamports: u64,
}

/// Instruction builder for `WithdrawMarginAccountCpiTlock`.
///
/// ### Accounts:
///
...
pub struct WithdrawMarginAccountCpiTlockBuilder {
...
impl WithdrawMarginAccountCpiTlockBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = WithdrawMarginAccountCpiTlock {
        ...
        let args = WithdrawMarginAccountCpiTlockInstructionArgs {
...
/// `withdraw_margin_account_cpi_tlock` CPI accounts.
pub struct WithdrawMarginAccountCpiTlockCpiAccounts<'a, 'b> {
...
/// `withdraw_margin_account_cpi_tlock` CPI instruction.
pub struct WithdrawMarginAccountCpiTlockCpi<'a, 'b> {
    ...
    pub __args: WithdrawMarginAccountCpiTlockInstructionArgs,
}

impl<'a, 'b> WithdrawMarginAccountCpiTlockCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: WithdrawMarginAccountCpiTlockCpiAccounts<'a, 'b>,
        args: WithdrawMarginAccountCpiTlockInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `WithdrawMarginAccountCpiTlock` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` margin_account
...
///   4. `[]` system_program
#[derive(Clone, Debug)]
pub struct WithdrawMarginAccountCpiTlockCpiBuilder<'a, 'b> {
    instruction: Box<WithdrawMarginAccountCpiTlockCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WithdrawMarginAccountCpiTlockCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(WithdrawMarginAccountCpiTlockCpiBuilderInstruction {
            __program: program,
            margin_account: None,
            order_state: None,
            owner: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = WithdrawMarginAccountCpiTlockCpi {
...
#[derive(Clone, Debug)]
struct WithdrawMarginAccountCpiTlockCpiBuilderInstruction<'a, 'b> {
