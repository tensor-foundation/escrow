...
impl WnsBuyNft {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = WnsBuyNftInstructionData::new().try_to_vec().unwrap();
...
struct WnsBuyNftInstructionData {
    discriminator: [u8; 8],
}

impl WnsBuyNftInstructionData {
    fn new() -> Self {
        Self {
...
pub struct WnsBuyNftInstructionArgs {
    pub config: PoolConfig,
    pub max_price: u64,
}

/// Instruction builder for `WnsBuyNft`.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
///   5. `[]` nft_mint
///   6. `[writable]` nft_escrow
///   7. `[writable]` nft_receipt
///   8. `[writable]` sol_escrow
///   9. `[writable]` owner
///   10. `[writable, signer]` buyer
...
impl WnsBuyNftBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = WnsBuyNftInstructionArgs {
...
/// `wns_buy_nft` CPI accounts.
pub struct WnsBuyNftCpiAccounts<'a, 'b> {
...
/// `wns_buy_nft` CPI instruction.
pub struct WnsBuyNftCpi<'a, 'b> {
    ...
    pub __args: WnsBuyNftInstructionArgs,
}

impl<'a, 'b> WnsBuyNftCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: WnsBuyNftCpiAccounts<'a, 'b>,
        args: WnsBuyNftInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `WnsBuyNft` via CPI.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
///   19. `[]` distribution_program
///   20. `[]` extra_metas
pub struct WnsBuyNftCpiBuilder<'a, 'b> {
    instruction: Box<WnsBuyNftCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WnsBuyNftCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(WnsBuyNftCpiBuilderInstruction {
            __program: program,
            tswap: None,
            fee_vault: None,
            pool: None,
...
struct WnsBuyNftCpiBuilderInstruction<'a, 'b> {
