...
impl WnsDepositNft {
    pub fn instruction(
        &self,
        args: WnsDepositNftInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = WnsDepositNftInstructionData::new().try_to_vec().unwrap();
...
struct WnsDepositNftInstructionData {
    discriminator: [u8; 8],
}

impl WnsDepositNftInstructionData {
    fn new() -> Self {
        Self {
...
pub struct WnsDepositNftInstructionArgs {
    pub config: PoolConfig,
}

/// Instruction builder for `WnsDepositNft`.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
///   16. `[]` extra_metas
#[derive(Default)]
pub struct WnsDepositNftBuilder {
...
impl WnsDepositNftBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = WnsDepositNftInstructionArgs {
...
/// `wns_deposit_nft` CPI accounts.
pub struct WnsDepositNftCpiAccounts<'a, 'b> {
...
/// `wns_deposit_nft` CPI instruction.
pub struct WnsDepositNftCpi<'a, 'b> {
    ...
    pub __args: WnsDepositNftInstructionArgs,
}

impl<'a, 'b> WnsDepositNftCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: WnsDepositNftCpiAccounts<'a, 'b>,
        args: WnsDepositNftInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `WnsDepositNft` via CPI.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
///   15. `[]` distribution_program
///   16. `[]` extra_metas
pub struct WnsDepositNftCpiBuilder<'a, 'b> {
    instruction: Box<WnsDepositNftCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WnsDepositNftCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(WnsDepositNftCpiBuilderInstruction {
            __program: program,
            tswap: None,
            pool: None,
            whitelist: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = WnsDepositNftCpi {
...
struct WnsDepositNftCpiBuilderInstruction<'a, 'b> {
