...
impl WnsWithdrawNft {
    pub fn instruction(
        &self,
        args: WnsWithdrawNftInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = WnsWithdrawNftInstructionData::new().try_to_vec().unwrap();
...
struct WnsWithdrawNftInstructionData {
    discriminator: [u8; 8],
}

impl WnsWithdrawNftInstructionData {
    fn new() -> Self {
        Self {
...
pub struct WnsWithdrawNftInstructionArgs {
    pub config: PoolConfig,
}

/// Instruction builder for `WnsWithdrawNft`.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
///   15. `[]` extra_metas
#[derive(Default)]
pub struct WnsWithdrawNftBuilder {
...
impl WnsWithdrawNftBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = WnsWithdrawNftInstructionArgs {
...
/// `wns_withdraw_nft` CPI accounts.
pub struct WnsWithdrawNftCpiAccounts<'a, 'b> {
...
/// `wns_withdraw_nft` CPI instruction.
pub struct WnsWithdrawNftCpi<'a, 'b> {
    ...
    pub __args: WnsWithdrawNftInstructionArgs,
}

impl<'a, 'b> WnsWithdrawNftCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: WnsWithdrawNftCpiAccounts<'a, 'b>,
        args: WnsWithdrawNftInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `WnsWithdrawNft` via CPI.
///
/// ### Accounts:
///
///   0. `[]` tswap
...
///   14. `[]` distribution_program
///   15. `[]` extra_metas
pub struct WnsWithdrawNftCpiBuilder<'a, 'b> {
    instruction: Box<WnsWithdrawNftCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WnsWithdrawNftCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(WnsWithdrawNftCpiBuilderInstruction {
            __program: program,
            tswap: None,
            pool: None,
            whitelist: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = WnsWithdrawNftCpi {
...
struct WnsWithdrawNftCpiBuilderInstruction<'a, 'b> {
