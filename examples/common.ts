...
export const keypairBytes = new Uint8Array([...new Uint8Array(32).map(() => 0), ...getAddressEncoder().encode(address("4zdNGgAtFsW1cQgHqkiWyRsxaAgxrSRRynnuunxzjxue"))]);
export const helius_url = "https://mainnet.helius-rpc.com/?api-key=<HELIUS_RPC_API_KEY>";
