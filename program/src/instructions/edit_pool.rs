...
pub struct EditPool<'info> {
    ...
    #[account(mut,
        ...
        has_one = nft_authority @ ErrorCode::WrongAuthority,
        constraint = old_pool.sol_escrow == old_sol_escrow.key() @ ErrorCode::BadEscrowAccount,
        constraint = old_pool.key() != new_pool.key() @ ErrorCode::PoolsAreTheSame,
        close = owner,
    )]
    ...
    #[account(
        ...
        constraint = old_pool.key() == nft_authority.pool @ ErrorCode::WrongAuthority,
    )]
