...
use anchor_spl::{
    ...
    token_interface::spl_token_2022::{extension::ExtensionType, state::Account},
    token_interface::{initialize_account3, spl_token_2022::extension::StateWithExtensions},
};
...
/// extension types will result in an error.
///
